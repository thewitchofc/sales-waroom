...
const previewLines = [
  {
    speaker: "לקוח",
    text: "זה יקר מדי בשבילנו. יש לכם משהו זול יותר?",
    tone: "text-white/70",
  },
  {
    speaker: "את/ה",
    text: "השאלה היא לא המחיר, אלא מה עולה לכם לא לפתור את זה עכשיו.",
    tone: "text-accent",
  },
  {
    speaker: "מאמן שטח",
    text: "שמירה על פריים. אל תתנצל/י על המחיר.",
        ...
        <div className="border-b border-white/5 bg-black/60 px-5 py-4 backdrop-blur-sm">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div className="flex items-center gap-2">
              ...
              />
              <span className="font-brand text-[10px] text-red-400">
                סימולציה חיה
              </span>
            </div>
        ...
        <div className="space-y-4 p-5 sm:p-6">
          <div className="relative overflow-hidden border border-white/5 bg-black/50 p-4">
            <div className="mb-3 flex items-center justify-between">
              ...
              <span className="font-brand text-[9px] text-green-400/90">
                ● מיקרופון פעיל
              </span>
            </div>
            ...
            {previewScores.map((score, i) => (
              ...
              >
                <div className="flex items-baseline justify-center gap-1">
                  ...
                  <span className="font-brand text-[9px] text-green-400">
                    {score.trend}
                  </span>
                </div>
