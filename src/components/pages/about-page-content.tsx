...
export function AboutPageContent() {
  return (
    <article className="mx-auto max-w-3xl px-5 pt-28 pb-20 sm:px-8 sm:pt-32 sm:pb-24">
      <p className="font-brand text-[10px] tracking-[0.15em] text-accent/70">
        אודות, SALES WAROOM
      </p>
      ...
      <blockquote className="mt-10 border-s-2 border-accent/40 ps-5 text-base leading-[1.85] text-white/75 sm:text-lg">
        <p>
          זה לא עוד קורס. לא עוד סרטונים. ולא עוד תאוריות שאף אחד לא משתמש בהן
          בשטח.
        </p>
      ...
      <p className="mt-8 text-sm leading-relaxed text-white/45 sm:text-base">
        כרגע אנחנו בישראל, אבל המטרה של Sales Waroom היא להפוך לסטנדרט החדש של
        הכשרת אנשי מכירות בעולם.
      </p>

      <footer className="mt-10 border-t border-white/[0.06] pt-10">
        <p className="text-base leading-[1.85] text-white/60 sm:text-lg">
          אנחנו ישראלים, הכרישים הכי גדולים במכירות בכל העולם. אבל בו זמנית
          הלקוחות הכי קשים שיש בעולם, מלכי ההתמקחות והעקשנות.
        </p>
        <p className="mt-6 font-display text-2xl font-black text-accent sm:text-3xl">
          אין עלינו!
        </p>
